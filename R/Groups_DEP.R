...
data <- read.csv("/Volumes/Samsung_T5/xinjiang_CTO/clinical_EDA/continuous_clinical/continuous_clinical_DEP.csv", header = T, row.names = 1, skip = 0)
ana_index <- read.csv("//Volumes/Samsung_T5/xinjiang_CTO/clinical_EDA/continuous_clinical/clinical_anatation.csv", header = T)
ana_index$id <- gsub("#", ".", ana_index$id)
table(ana_index$type)
# perform wilcoxn_test
...
write.csv(res, "/Volumes/Samsung_T5/xinjiang_CTO/clinical_EDA/continuous_clinical/significance_analysis/continuous_clinical_info_DEP_Bad_Good_Circulation_wilcoxn_test.csv")
